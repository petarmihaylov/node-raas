...
export async function logOnAction(clients: Clients, raasCredential: RaasCredential, flags: any): Promise<RaasLogOnCallResult> {
  ...
  cli.action.stop(`${chalk.green('Success')} | ${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(logOnResult.correlationId)} | ${blueMagenta('Took:', `${msElapsedLogOn / 1000}s`)}`)
  // Login - End
  return logOnResult
}
...
export async function getReportParametersAction(clients: Clients, logOnResult: RaasLogOnCallResult, reportPath: string, flags: any): Promise<void> {
  ...
  if (getReportParametersResult.hasErrors) {
    cli.action.stop(`${chalk.red('Failed')} | ${blueMagenta('Took:', `${msElapsedGetReportParameters / 1000}s`)}`)
  ...
  cli.action.stop(`${chalk.green('Success')} | ${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(getReportParametersResult.correlationId)} | ${blueMagenta('Took:', `${msElapsedGetReportParameters / 1000}s`)}`)

  if (getReportParametersResult.hasWarnings) {
    const error = flags.verbose ?
      new Error(`${chalk.blue('GetReportParameters:')} ${chalk.red('Warn')}
${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(getReportParametersResult.correlationId)}
${chalk.blue('GetReportParametersResult:')} ${chalk.red(JSON.stringify(getReportParametersResult.result[0].GetReportParametersResult, undefined, 2))}
${chalk.blue('SOAP Request Headers:')} ${chalk.red(JSON.stringify(getReportParametersResult.result[2], undefined, 2))}
${chalk.blue('Raw XML Request:')} ${chalk.red(JSON.stringify(getReportParametersResult.result[3], undefined, 2))}
${chalk.blue('Raw XML Response:')} ${chalk.red(JSON.stringify(getReportParametersResult.result[1], undefined, 2))}
...
${chalk.yellow(getReportParametersResult.warningMessage)}`)
  ...
  if (flags?.console) {
    console.log(chalk.blue(JSON.stringify(getReportParametersResult.result[0].GetReportParametersResult, undefined, 2)))
  }
}
...
export async function executeReportAction(clients: Clients,  logOnResult: RaasLogOnCallResult, reportPath: string, flags: any): Promise<RaasExecuteReportCallResult> {
  ...
  if (executeReportResult.hasErrors) {
    cli.action.stop(`${chalk.red('Failed')} | ${blueMagenta('Took:', `${msElapsedExecuteReport / 1000}s`)}`)
    handleBiDataServiceErrors(executeReportResult, 'ExecuteReportResult', flags.verbose)
  }

  cli.action.stop(`${chalk.green('Success')} | ${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(executeReportResult.correlationId)} | ${blueMagenta('Took:', `${msElapsedExecuteReport / 1000}s`)}`)
  // Execute Report - End
...
export async function retrieveReportActon(clients: Clients, executeReportResult: RaasExecuteReportCallResult, flags: any): Promise<RaasRetrieveReportCallResult> {
  ...
  if (retrieveReportResult.hasErrors) {
    cli.action.stop(`${chalk.green('Success')} | ${blueMagenta('Took:', `${msElapsedRetrieveReport / 1000}s`)}`)
...
${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(retrieveReportResult.correlationId)}
${chalk.blue('ReportStream:')} ${chalk.red(JSON.stringify(retrieveReportResult.result[0].ReportStream, undefined, 2))}
${chalk.blue('SOAP Request Headers:')} ${chalk.red(JSON.stringify(retrieveReportResult.result[2], undefined, 2))}
${chalk.blue('Raw XML Request:')} ${chalk.red(JSON.stringify(retrieveReportResult.result[3], undefined, 2))}
${chalk.blue('Raw XML Response:')} ${chalk.red(JSON.stringify(retrieveReportResult.result[1], undefined, 2))}
Troubleshooting suggestions:
...
${chalk.yellow(retrieveReportResult.warningMessage)}`)
  ...
  cli.action.stop(`${chalk.green('Success')} | ${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(executeReportResult.correlationId)} | ${blueMagenta('Took:', `${msElapsedRetrieveReport / 1000}s`)}`)
  // Retrieve Report - End
...
export async function logOffAction(clients: Clients,  logOnResult: RaasLogOnCallResult, flags: any): Promise<any> {
  ...
  // this.log(`${blue(`LogOn:`)} ${green(`Success`)} | ${blue(`US-CORRELATION-ID:`)} ${magenta(logOnResult.correlationId)}`)
  cli.action.stop(`${chalk.green('Success')} | ${chalk.blue('US-CORRELATION-ID:')} ${chalk.magenta(logOnResult.correlationId)} | ${blueMagenta('Took:', `${msElapsedLogOff / 1000}s`)}`)
  // LogOff - End
  return {}
}
